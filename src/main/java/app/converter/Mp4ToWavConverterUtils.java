...
public class Mp4ToWavConverterUtils extends ConverterUtils implements FileConverter {

    private static final Logger LOGGER = LoggerFactory.getLogger(Mp4ToWavConverterUtils.class);
